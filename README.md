...
![GitHub followers](https://img.shields.io/github/followers/d3va-12?label=follow\&style=flat-square)
![GitHub stats](https://github-readme-stats.vercel.app/api?username=d3va-12\&show_icons=true\&theme=tokyonight)
...
**Overview:** Local deployment and fine‑tuning of Mistral‑7B‑Instruct (quantized) to act as a concise, friendly career advisor.
...
**Tech:** Mistral 7B (GPTQ), Python backend, Node/Express orchestration, WebSocket chat frontend.
...
* **Languages:** JavaScript (React), TypeScript, Python, SQL, HTML, CSS
* **AI / LLMs:** Mistral 7B, PyTorch, prompt engineering
* **Data & BI:** Power BI, Pandas, NumPy
* **Backend:** Node.js, Express, MongoDB, MySQL
* **Dev Tools:** Git, Docker, FFmpeg, VSCode
